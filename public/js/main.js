(() => {
  // ns-hugo-imp:/home/felix/repo/ai-symposium/themes/2026/assets/js/ai-bg-animation.js
  (function() {
    ...
    function initParticles() {
      ...
      const particleCount = isMobile ? Math.min(56, Math.max(24, Math.floor(W * H / 14e3))) : Math.min(90, Math.max(45, Math.floor(W * H / 7e3)));
    ...
    function drawGrid() {
      ...
      for (let r = 0; r <= GR; r++) {
        ...
        for (let c = 0; c <= GC; c++) {
          ...
          const wave = Math.sin(gx * 2.4 + gz * 1.7 - t * 12e-4) * 0.065;
    ...
    function drawGlow() {
      ...
      const pulse = 0.5 + 0.5 * Math.sin(t * 6e-4);
